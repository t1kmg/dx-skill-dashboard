...
const FLASHCARDS = [
  // G検定
  // phase: 'g-p1'=AI概論・機械学習, 'g-p2'=DL基礎・CNN, 'g-p3'=DL応用・最新技術, 'g-p4'=数理・統計・AIと社会
  // chapter: 白本（G検定公式テキスト）の章立て（参考）
  { id: 'fc-g-01', cert: 'g-ken', certLabel: 'G検定', phase: 'g-p1', phaseLabel: 'Phase 1: AI概論・機械学習', chapter: '3', chapterLabel: '第3章 機械学習の具体的手法', term: '教師あり学習', definition: 'ラベル付きデータ（正解）を使ってモデルを学習する手法。分類・回帰問題に使用。例：スパムフィルタ・住宅価格予測。' },
  { id: 'fc-g-02', cert: 'g-ken', certLabel: 'G検定', phase: 'g-p1', phaseLabel: 'Phase 1: AI概論・機械学習', chapter: '3', chapterLabel: '第3章 機械学習の具体的手法', term: '教師なし学習', definition: 'ラベルなしデータからパターンや構造を自律的に発見する手法。クラスタリング・次元削減・密度推定など。' },
  { id: 'fc-g-03', cert: 'g-ken', certLabel: 'G検定', phase: 'g-p1', phaseLabel: 'Phase 1: AI概論・機械学習', chapter: '3', chapterLabel: '第3章 機械学習の具体的手法', term: '強化学習', definition: 'エージェントが環境と試行錯誤しながら報酬を最大化する行動を学ぶ手法。囲碁AI（AlphaGo）やゲームAIで活用。' },
  { id: 'fc-g-04', cert: 'g-ken', certLabel: 'G検定', phase: 'g-p2', phaseLabel: 'Phase 2: DL基礎・CNN', chapter: '4', chapterLabel: '第4章 ディープラーニングの概要', term: '誤差逆伝播法（バックプロパゲーション）', definition: 'NNの損失を出力層から入力層方向へ微分の連鎖律（chain rule）で伝播させ、各重みを更新するアルゴリズム。' },
  { id: 'fc-g-05', cert: 'g-ken', certLabel: 'G検定', phase: 'g-p2', phaseLabel: 'Phase 2: DL基礎・CNN', chapter: '5', chapterLabel: '第5章 ディープラーニングの要素技術', term: 'ReLU（Rectified Linear Unit）', definition: '活性化関数の一種。f(x) = max(0, x)。負の値を0に切り捨て、勾配消失問題を軽減する。現在最も広く使われる。' },
  { id: 'fc-g-06', cert: 'g-ken', certLabel: 'G検定', phase: 'g-p1', phaseLabel: 'Phase 1: AI概論・機械学習', chapter: '3', chapterLabel: '第3章 機械学習の具体的手法', term: '過学習（オーバーフィッティング）', definition: '訓練データに過度に適合し、未知データへの汎化性能が低下する問題。ドロップアウト・正則化・データ拡張で対策。' },
  { id: 'fc-g-07', cert: 'g-ken', certLabel: 'G検定', phase: 'g-p2', phaseLabel: 'Phase 2: DL基礎・CNN', chapter: '5', chapterLabel: '第5章 ディープラーニングの要素技術', term: 'ドロップアウト', definition: '学習中にランダムにニューロンを無効化する正則化手法。過学習を防ぎ、アンサンブル効果も得られる。' },
  { id: 'fc-g-08', cert: 'g-ken', certLabel: 'G検定', phase: 'g-p2', phaseLabel: 'Phase 2: DL基礎・CNN', chapter: '6', chapterLabel: '第6章 ディープラーニングの応用', term: 'CNN（畳み込みニューラルネットワーク）', definition: '画像認識に特化したNN。畳み込み層（特徴抽出）＋プーリング層（ダウンサンプリング）で空間的な特徴を学習する。' },
  { id: 'fc-g-09', cert: 'g-ken', certLabel: 'G検定', phase: 'g-p3', phaseLabel: 'Phase 3: DL応用・最新技術', chapter: '6', chapterLabel: '第6章 ディープラーニングの応用', term: 'Transformer', definition: 'Self-Attention機構のみで構成されるDLアーキテクチャ（2017年Vaswaniら提案）。BERTやGPTの基盤。RNNより並列処理が得意。' },
  { id: 'fc-g-10', cert: 'g-ken', certLabel: 'G検定', phase: 'g-p3', phaseLabel: 'Phase 3: DL応用・最新技術', chapter: '6', chapterLabel: '第6章 ディープラーニングの応用', term: '転移学習（Transfer Learning）', definition: '大規模データで学習済みのモデルを、別の（少データ）タスクに応用する手法。事前学習＋ファインチューニングが典型。' },
  { id: 'fc-g-11', cert: 'g-ken', certLabel: 'G検定', phase: 'g-p1', phaseLabel: 'Phase 1: AI概論・機械学習', chapter: '1', chapterLabel: '第1章 人工知能とは何か', term: 'シンギュラリティ（技術的特異点）', definition: 'AIが人類の知能を超え、技術進歩が加速度的になるとされる転換点。レイ・カーツワイルが2045年頃と予測。' },
  { id: 'fc-g-12', cert: 'g-ken', certLabel: 'G検定', phase: 'g-p4', phaseLabel: 'Phase 4: 数理・統計・AIと社会', chapter: '7', chapterLabel: '第7章 数理・統計', term: 'ベイズ推定', definition: '事前確率に観測データを加えてベイズの定理で事後確率を更新する確率的推論。P(A|B) = P(B|A)P(A)/P(B)。' },
  { id: 'fc-g-13', cert: 'g-ken', certLabel: 'G検定', phase: 'g-p2', phaseLabel: 'Phase 2: DL基礎・CNN', chapter: '6', chapterLabel: '第6章 ディープラーニングの応用', term: 'GAN（敵対的生成ネットワーク）', definition: '生成器（Generator）と識別器（Discriminator）が競い合い、本物そっくりのデータを生成するモデル。画像生成などに活用。' },
  { id: 'fc-g-14', cert: 'g-ken', certLabel: 'G検定', phase: 'g-p3', phaseLabel: 'Phase 3: DL応用・最新技術', chapter: '6', chapterLabel: '第6章 ディープラーニングの応用', term: 'BERT', definition: 'GoogleのBidirectional Encoder Representations from Transformers。文章を両方向から理解するTransformerモデル。事前学習＋FTで多タスク対応。' },
  { id: 'fc-g-15', cert: 'g-ken', certLabel: 'G検定', phase: 'g-p2', phaseLabel: 'Phase 2: DL基礎・CNN', chapter: '4', chapterLabel: '第4章 ディープラーニングの概要', term: '損失関数（Loss Function）', definition: 'モデルの予測値と正解の誤差を定量化する関数。分類には交差エントロピー、回帰にはMSE（平均二乗誤差）が一般的。' },
  { id: 'fc-g-16', cert: 'g-ken', certLabel: 'G検定', phase: 'g-p2', phaseLabel: 'Phase 2: DL基礎・CNN', chapter: '5', chapterLabel: '第5章 ディープラーニングの要素技術', term: '勾配消失問題', definition: 'DNN学習時、誤差逆伝播で入力層に近づくほど勾配が0に近づく問題。ReLUや残差接続（ResNet）で対策。' },
  { id: 'fc-g-17', cert: 'g-ken', certLabel: 'G検定', phase: 'g-p3', phaseLabel: 'Phase 3: DL応用・最新技術', chapter: '6', chapterLabel: '第6章 ディープラーニングの応用', term: 'Attention機構', definition: 'シーケンス内の各要素が他の要素とどれだけ関連するかを重み付けする仕組み。Transformerの中核。' },
  { id: 'fc-g-18', cert: 'g-ken', certLabel: 'G検定', phase: 'g-p4', phaseLabel: 'Phase 4: 数理・統計・AIと社会', chapter: '7', chapterLabel: '第7章 数理・統計', term: '正規分布（ガウス分布）', definition: '平均μと分散σ²で定まる釣り鐘型の確率分布。機械学習での誤差分布の仮定や初期化などで広く登場。' },
  { id: 'fc-g-19', cert: 'g-ken', certLabel: 'G検定', phase: 'g-p3', phaseLabel: 'Phase 3: DL応用・最新技術', chapter: '6', chapterLabel: '第6章 ディープラーニングの応用', term: 'ファインチューニング', definition: '大規模データで事前学習したモデルを、少量のタスク固有データで追加学習する転移学習の手法。' },
  { id: 'fc-g-20', cert: 'g-ken', certLabel: 'G検定', phase: 'g-p2', phaseLabel: 'Phase 2: DL基礎・CNN', chapter: '5', chapterLabel: '第5章 ディープラーニングの要素技術', term: 'ハイパーパラメータ', definition: '学習前に人手で設定するパラメータ。学習率・バッチサイズ・層数・ドロップアウト率など。グリッドサーチや自動探索で最適化。' },
  // SC試験
  ...
  // G検定 追加カード（21〜40）
  { id: 'fc-g-21', cert: 'g-ken', certLabel: 'G検定', phase: 'g-p3', phaseLabel: 'Phase 3: DL応用・最新技術', chapter: '6', chapterLabel: '第6章 ディープラーニングの応用', term: '自己教師あり学習', definition: 'ラベルなしデータから擬似ラベルを自動生成して学習する手法。大規模テキスト・画像の事前学習（BERTのMasked LM、CLIPなど）に活用。ラベルコストを大幅に削減できる。' },
  { id: 'fc-g-22', cert: 'g-ken', certLabel: 'G検定', phase: 'g-p3', phaseLabel: 'Phase 3: DL応用・最新技術', chapter: '6', chapterLabel: '第6章 ディープラーニングの応用', term: '対照学習（Contrastive Learning）', definition: '同じ意味を持つサンプルを近く・異なるサンプルを遠くに配置するように表現を学習する手法。SimCLR・MoCo・CLIPなどが代表例。ラベルなしで高品質な特徴表現が得られる。' },
  { id: 'fc-g-23', cert: 'g-ken', certLabel: 'G検定', phase: 'g-p2', phaseLabel: 'Phase 2: DL基礎・CNN', chapter: '6', chapterLabel: '第6章 ディープラーニングの応用', term: '拡散モデル（Diffusion Model）', definition: 'データに徐々にノイズを加える正拡散と、それを逆向きに学習する逆拡散で高品質な生成を行うモデル。Stable Diffusion・DALL-E 3の基盤技術。GANより安定した学習が可能。' },
  { id: 'fc-g-24', cert: 'g-ken', certLabel: 'G検定', phase: 'g-p3', phaseLabel: 'Phase 3: DL応用・最新技術', chapter: '6', chapterLabel: '第6章 ディープラーニングの応用', term: 'LLM（大規模言語モデル）', definition: '数百億〜兆規模のパラメータを持つTransformerベースの言語モデル。GPT-4・Gemini・Claudeなど。Few-shot学習（In-context learning）や指示追従能力が高い。' },
  { id: 'fc-g-25', cert: 'g-ken', certLabel: 'G検定', phase: 'g-p3', phaseLabel: 'Phase 3: DL応用・最新技術', chapter: '6', chapterLabel: '第6章 ディープラーニングの応用', term: 'RAG（検索拡張生成）', definition: 'LLMが回答生成時に外部知識ベースを検索し、取得した文書を文脈に加えて応答する手法。ハルシネーション低減・最新情報への対応・情報源の明示が可能になる。' },
  { id: 'fc-g-26', cert: 'g-ken', certLabel: 'G検定', phase: 'g-p3', phaseLabel: 'Phase 3: DL応用・最新技術', chapter: '6', chapterLabel: '第6章 ディープラーニングの応用', term: 'プロンプトエンジニアリング', definition: 'LLMへの入力（プロンプト）を工夫して望む出力を引き出す技術。Few-shot・Chain-of-Thought・Role Promptingなどの手法がある。モデルの再学習なしで性能改善できる。' },
  { id: 'fc-g-27', cert: 'g-ken', certLabel: 'G検定', phase: 'g-p3', phaseLabel: 'Phase 3: DL応用・最新技術', chapter: '6', chapterLabel: '第6章 ディープラーニングの応用', term: 'ハルシネーション（幻覚）', definition: 'LLMが事実と異なる情報を自信を持って生成してしまう問題。知識の更新遅れ・確率的生成に起因。RAG・ファクトチェック・温度パラメータの調整で対策する。' },
  { id: 'fc-g-28', cert: 'g-ken', certLabel: 'G検定', phase: 'g-p1', phaseLabel: 'Phase 1: AI概論・機械学習', chapter: '3', chapterLabel: '第3章 機械学習の具体的手法', term: 'SVM（サポートベクターマシン）', definition: 'クラス間マージンを最大化する境界超平面を求める分類器。カーネルトリックにより非線形分類も可能。少量データで高性能を発揮するが、大規模データには不向き。' },
  { id: 'fc-g-29', cert: 'g-ken', certLabel: 'G検定', phase: 'g-p1', phaseLabel: 'Phase 1: AI概論・機械学習', chapter: '3', chapterLabel: '第3章 機械学習の具体的手法', term: 'k-means法', definition: 'データをk個のクラスタに分割する代表的な教師なしクラスタリング手法。各クラスタの重心を反復更新して収束させる。kの選択にエルボー法やシルエット係数を使用する。' },
  { id: 'fc-g-30', cert: 'g-ken', certLabel: 'G検定', phase: 'g-p1', phaseLabel: 'Phase 1: AI概論・機械学習', chapter: '3', chapterLabel: '第3章 機械学習の具体的手法', term: '主成分分析（PCA）', definition: 'データの分散が最大になる方向（主成分）へ射影して次元を削減する手法。固有値分解または特異値分解で計算。可視化・ノイズ除去・特徴圧縮に活用される。' },
  { id: 'fc-g-31', cert: 'g-ken', certLabel: 'G検定', phase: 'g-p1', phaseLabel: 'Phase 1: AI概論・機械学習', chapter: '3', chapterLabel: '第3章 機械学習の具体的手法', term: '混同行列（Confusion Matrix）', definition: '分類モデルの予測結果をTP（真陽性）・FP（偽陽性）・FN（偽陰性）・TN（真陰性）で整理した表。適合率・再現率・F値・正解率の計算基礎となる。' },
  { id: 'fc-g-32', cert: 'g-ken', certLabel: 'G検定', phase: 'g-p1', phaseLabel: 'Phase 1: AI概論・機械学習', chapter: '3', chapterLabel: '第3章 機械学習の具体的手法', term: 'F値（F1スコア）', definition: '適合率（Precision）と再現率（Recall）の調和平均。F1 = 2×P×R÷(P+R)。クラス不均衡データで正解率より有効な評価指標。マクロ/マイクロ平均がある。' },
  { id: 'fc-g-33', cert: 'g-ken', certLabel: 'G検定', phase: 'g-p2', phaseLabel: 'Phase 2: DL基礎・CNN', chapter: '5', chapterLabel: '第5章 ディープラーニングの要素技術', term: 'バッチ正規化（Batch Normalization）', definition: 'ミニバッチ単位でニューロンの出力を平均0・分散1に正規化する手法。学習の安定化・高速化・過学習抑制に効果。ReLUの前後どちらに置くかは設計による。' },
  { id: 'fc-g-34', cert: 'g-ken', certLabel: 'G検定', phase: 'g-p2', phaseLabel: 'Phase 2: DL基礎・CNN', chapter: '5', chapterLabel: '第5章 ディープラーニングの要素技術', term: '残差接続（スキップ接続）', definition: 'ブロックの入力をそのまま出力に加算するショートカット。ResNetで採用。勾配消失問題を緩和し100層以上の超深層NNの学習を可能にした。現代のDLアーキテクチャの標準。' },
  { id: 'fc-g-35', cert: 'g-ken', certLabel: 'G検定', phase: 'g-p3', phaseLabel: 'Phase 3: DL応用・最新技術', chapter: '6', chapterLabel: '第6章 ディープラーニングの応用', term: 'LSTM（長短期記憶）', definition: '系列データの長距離依存関係を学習するRNNの改良版。入力ゲート・忘却ゲート・出力ゲートで情報を選択的に保持・破棄する。勾配消失問題をバニリングRNNより大幅に改善。' },
  { id: 'fc-g-36', cert: 'g-ken', certLabel: 'G検定', phase: 'g-p3', phaseLabel: 'Phase 3: DL応用・最新技術', chapter: '6', chapterLabel: '第6章 ディープラーニングの応用', term: 'Word2Vec', definition: '単語を密ベクトル（分散表現）で表す技術。CBOW（文脈→単語）とSkip-gram（単語→文脈）の2モデルがある。「王−男+女≈女王」のような意味演算が可能。' },
  { id: 'fc-g-37', cert: 'g-ken', certLabel: 'G検定', phase: 'g-p2', phaseLabel: 'Phase 2: DL基礎・CNN', chapter: '5', chapterLabel: '第5章 ディープラーニングの要素技術', term: 'データ拡張（Data Augmentation）', definition: '訓練データに回転・反転・色変換・ノイズ付加などの変換を加えてデータ量を擬似的に増やす手法。過学習を防ぎ汎化性能を向上させる。特に画像分野で広く利用。' },
  { id: 'fc-g-38', cert: 'g-ken', certLabel: 'G検定', phase: 'g-p4', phaseLabel: 'Phase 4: 数理・統計・AIと社会', chapter: '8', chapterLabel: '第8章 AIと社会', term: 'AI倫理・説明可能性（XAI）', definition: 'AIの判断の公平性・透明性・説明責任を確保するための原則と技術。LIME・SHAPなどの解釈手法がある。EU AI Actでも高リスクAIへの説明責任が義務化。' },
  { id: 'fc-g-39', cert: 'g-ken', certLabel: 'G検定', phase: 'g-p4', phaseLabel: 'Phase 4: 数理・統計・AIと社会', chapter: '8', chapterLabel: '第8章 AIと社会', term: '連合学習（Federated Learning）', definition: 'データを中央サーバに送らず端末上でモデルを学習し、モデル更新（勾配）のみを集約する分散学習手法。プライバシー保護と省通信量が特長。医療・金融分野で注目。' },
  { id: 'fc-g-40', cert: 'g-ken', certLabel: 'G検定', phase: 'g-p3', phaseLabel: 'Phase 3: DL応用・最新技術', chapter: '6', chapterLabel: '第6章 ディープラーニングの応用', term: 'マルチモーダルAI', definition: '画像・テキスト・音声など複数のモダリティ（様式）を統合して扱うAI。CLIP（画像×テキスト）、GPT-4V（画像理解）、Geminiなどが代表例。視覚QAや画像キャプション生成に活用。' },
